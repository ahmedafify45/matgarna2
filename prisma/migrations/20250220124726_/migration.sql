/*
  ...
  - The values [MEDIUM,LARGE] on the enum `ProductSizes` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
BEGIN;
CREATE TYPE "ProductSizes_new" AS ENUM ('SMALL', 'MEDUIM', 'EXTRA_LARGE');
